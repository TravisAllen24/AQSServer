...
class SerialCollector:
    ...
    def run(self):
        self.logger.info(f"Starting SerialCollector on {self.com_port} at {self.baudrate} baud, polling every {self.polling_interval} seconds")
        ...
        with client_socket:
            ...
            while True:
                ...
                try:
                    ...
                    self.logger.exception(f"Error while echoing data to client {client_address}")
                    break
