...
class AQSData:
    ...
    def update_data(self):
        ...
        self.dt,self.temp,self.humidity,self.dew_point,self.co2,self.voc_raw,self.voc_index,self.nox_raw,self.nox_index,self.pm100,self.pm25,self.pm10=last_row
