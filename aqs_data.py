        ...
        with open('data_log.csv', newline='') as f:
            ...
            for row in reader:
                ...
                if dt > last_dt:
                    ...
                    self.co2s.append(format_value(row[3]))
                    self.voc_raws.append(format_value(row[4]))
                    self.voc_indexs.append(format_value(row[5]))
                    self.nox_raws.append(format_value(row[6]))
                    self.nox_indexs.append(format_value(row[7]))
                    self.pm100s.append(format_value(row[8]))
                    self.pm25s.append(format_value(row[9]))
                    self.pm10s.append(format_value(row[10]))
